...
sealed class AuthEvent with _$AuthEvent {
  ...
  const factory AuthEvent.loginSubmitted({required String email, required String password}) = LoginSubmitted;
  const factory AuthEvent.signUpSubmitted({required String email, required String password}) = SignUpSubmitted;
