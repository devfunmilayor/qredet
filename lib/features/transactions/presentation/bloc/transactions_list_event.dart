...
sealed class TransactionsListEvent with _$TransactionsListEvent {
  ...
  const factory TransactionsListEvent.moreRequested() = TransactionsListMoreRequested;
  const factory TransactionsListEvent.searched(String query) = TransactionsListSearched;
}
